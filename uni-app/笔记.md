...
![](C:\Users\hp\Desktop\03_学习资源\01_学习笔记\13_uni-app\讲义\images\2view.png)
...
- **如果获取事件对象也想传递参数可以通过$event获取事件对象**
...
默认是get请求，若需发送其他请求在request对象参数里再配置一个method：post -> **发送post请求**
