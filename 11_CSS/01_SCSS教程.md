...
简介：**[Sass](https://links.jianshu.com/go?to=http%3A%2F%2Fsass-lang.com%2F)**是成熟、稳定、强大的**CSS预处理器**，而SCSS是Sass3版本当中引入的新语法特性，完全兼容CSS3的同时继承了Sass强大的动态功能。
...
命令空间上可以直接书写CSS简写属性，但是日常开发中建议直接书写CSS属性，尽量保持CSS语法的一致性。
