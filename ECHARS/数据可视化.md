...
- 设计稿是1920px  
  ...
  2. **cssrem 插件**的基准值是  80px 

     插件-配置按钮---配置扩展设置--Root Font Size 里面 设置。 

     但是别忘记重启vscode软件保证生效
     
  3. 是可以将px自动转换为rem的插件，基准值为80px就相当于1rem = 80px
...
![image-20201202202117944](C:\Users\hp\AppData\Roaming\Typora\typora-user-images\image-20201202202117944.png)
