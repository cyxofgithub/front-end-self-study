...
参考 [讲讲 webpack 优化](../../../../工程化/webpack/面试题/讲讲webpack优化.md)
...
参考 [断点续传](../../../../性能与浏览器/浏览器原理/前端常见问题/断点续传怎么做.md)
...
参考[HTTP 状态码的分类与含义](../../../../网络与安全/计算机网络/面试题/计算机网络.md)

### 数组乱序，为什么从后往前

做法[乱序的数组](../../../../数据结构与算法/面试题/2025总结/code/社招面筋/乱序的数组.js)

总结：从后往前时，每轮从 [0, i] 中选一个索引与 i 交换，之后 i 不再参与，从而避免重复选择已处理位置。这是 Fisher-Yates 洗牌算法的标准实现方式

### 如何实现垂直居中

参考[垂直居中方式](../../../../面经汇总/面经总结.md)
