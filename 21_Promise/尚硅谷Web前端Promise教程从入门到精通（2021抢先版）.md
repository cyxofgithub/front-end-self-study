...
<html lang="en">
    ...
    <body>
        <script>
            ...
            sendAJAX(
                'http://120.77.156.205:9804/breed/dovecoteOutBill/findBillByDovecoteAndType?baseId=12&dovecoteNumber=A01&type=肉鸽&pageNum=1&pageSize=10'
            ).then(
                (value) => {
                    console.log(value);
                },
...
### 10-1 异步修改状态 then 方法返回结果（自己封装到这里）
