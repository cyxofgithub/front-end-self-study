...
**如果父组件需要与grandson通信，除了vuex，必须先与son组件通信，再由son与grandson通信，在层级比较少的情况下也无可厚非，但是层级一旦多起来是很可怕的**
...
用于于添加或者删除数据后重新加载组件起到更新数据的作用

**实例**

![img](https://img-blog.csdn.net/20180527111226866)

![img](https://img-blog.csdn.net/20180527111803376)
