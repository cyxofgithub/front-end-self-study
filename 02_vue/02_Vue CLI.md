...
### [#](https://cli.vuejs.org/zh/guide/creating-a-project.html#vue-create)vue create（重点）
...
### [#](https://cli.vuejs.org/zh/guide/creating-a-project.html#拉取-2-x-模板-旧版本)拉取 2.x 模板 (旧版本)（了解）
...
### [#](https://cli.vuejs.org/zh/guide/cli-service.html#使用命令)使用命令（重点）
...
### [#](https://cli.vuejs.org/zh/guide/cli-service.html#vue-cli-service-serve)vue-cli-service serve（重点）
