...
![image-20210831091008568](尚硅谷Nginx教程由浅入深笔记 .assets/image-20210831091008568.png)

## Nginx 简介

### 1、什么是 Nginx

![image-20210901095250644](尚硅谷Nginx教程由浅入深笔记 .assets/image-20210901095250644.png)

### 2、反向代理

- 正向代理：

![image-20210901095543948](尚硅谷Nginx教程由浅入深笔记 .assets/image-20210901095543948.png)

tips：客户访问 google.com 不是直接访问，而是先访问代理服务器（需要在客户端先配置），代理服务器去访问谷歌，这就是所谓的正向代理

- 反向代理：

![image-20210901100211427](尚硅谷Nginx教程由浅入深笔记 .assets/image-20210901100211427.png)

![image-20210901100253479](尚硅谷Nginx教程由浅入深笔记 .assets/image-20210901100253479.png)
...
![image-20210901103953292](尚硅谷Nginx教程由浅入深笔记 .assets/image-20210901103953292.png)

### 3、负载均衡

![image-20210901101622505](尚硅谷Nginx教程由浅入深笔记 .assets/image-20210901101622505.png)

![image-20210901101629290](尚硅谷Nginx教程由浅入深笔记 .assets/image-20210901101629290.png)

### 4、动静分离

![image-20210901103158969](尚硅谷Nginx教程由浅入深笔记 .assets/image-20210901103158969.png)

![image-20210901103218921](尚硅谷Nginx教程由浅入深笔记 .assets/image-20210901103218921.png)

tips：jsp、sevelet 能动态生成 HTML

## Nginx 安装

![image-20210901113515519](尚硅谷Nginx教程由浅入深笔记 .assets/image-20210901113515519.png)

![image-20210901113524268](尚硅谷Nginx教程由浅入深笔记 .assets/image-20210901113524268.png)

![image-20210901113533977](尚硅谷Nginx教程由浅入深笔记 .assets/image-20210901113533977.png)

## Nginx 常用命令

![image-20210902100934254](尚硅谷Nginx教程由浅入深笔记 .assets/image-20210902100934254.png)

## Nginx 配置文件

![image-20210902101947142](尚硅谷Nginx教程由浅入深笔记 .assets/image-20210902101947142.png)
...
![image-20210902112746339](尚硅谷Nginx教程由浅入深笔记 .assets/image-20210902112746339.png)



![image-20210902112845388](尚硅谷Nginx教程由浅入深笔记 .assets/image-20210902112845388.png)

![image-20210902112852008](尚硅谷Nginx教程由浅入深笔记 .assets/image-20210902112852008.png)
